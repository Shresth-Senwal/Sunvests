...
const SoftwareEngineeringPage = () => {
  return (
    <Layout>
      ...
      <HeroSection
        backgroundImage="https://images.unsplash.com/photo-1555066931-4365d14bab8c?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80"
        backgroundAlt="Software Engineering and Development"
        gradientOverlay="from-blue-900/95 via-indigo-900/90 to-purple-900/95"
        theme="it"
        height="large"
        badge={{
          icon: '💻',
          text: 'Full-Stack Software Engineering'
        }}
        title={{
          main: 'Software',
        ...
        description="Build robust, scalable software solutions with our <span class='text-blue-300 font-semibold'>full-stack development expertise</span>, <span class='text-indigo-300 font-semibold'>modern architectures</span>, and <span class='text-purple-300 font-semibold'>agile methodologies</span>"
        buttons={{
          primary: {
        ...
        trustIndicators={[
          ...
          { text: 'Modern Frameworks', color: SERVICE_CATEGORIES.IT_SERVICES.colors.accent },
          { text: 'Agile Methodology', color: SERVICE_CATEGORIES.IT_SERVICES.colors.accent },
          { text: 'Quality Assurance', color: SERVICE_CATEGORIES.IT_SERVICES.colors.accent }
        ]}
        scrollText="Explore development services"
      />
      ...
      <Section id="services" background="white">
        <SectionHeader
          ...
          description="End-to-end software development solutions covering frontend, backend, mobile, and enterprise applications."
        />
      ...
      <Section background="gradient">
        <SectionHeader
          ...
          description="We leverage the latest technologies and frameworks to build modern, scalable software solutions."
        />
      ...
      <Section background="white">
        <SectionHeader
          ...
          description="Agile methodology ensuring quality delivery, continuous collaboration, and rapid iteration."
        />
      ...
      <Section background="gradient">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <SectionHeader
              title="Why Choose Our Software Engineering Services?"
              description="We combine technical excellence with business understanding to deliver software that drives real value."
              alignment="left"
            />
              ...
              {[
                {
                  ...
                  description: 'Complete software development capabilities from frontend to backend and everything in between.',
                  icon: '🔧'
                },
                {
                ...
                },
                {
                  ...
                  description: 'Rigorous testing and quality control processes ensuring reliable, bug-free software.',
                  icon: '🛡️'
                }
              ].map((feature, index) => (
                <motion.div
        ...
        <div className="bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 rounded-3xl p-12 text-center text-white shadow-2xl">
          ...
          >
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto text-blue-100 leading-relaxed">
              Let our software engineering experts help you transform your ideas into powerful, scalable applications.
            </p>
